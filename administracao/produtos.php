...
<body>
    ...
    <main class="main-wrap">
        ...
        <section class="content-main">
            <div class="content-header">
                <div>
                    <h2 class="content-title card-title">Lista de Produtos</h2>
                    <p>Todos os produtos da sua loja.</p>
                </div>
                <div>
                    <a href="ordenar-produtos.php" class="btn btn-primary btn-sm rounded mr-15">Ordenar Produtos</a>
                    <a href="inserir-produto.php" class="btn btn-primary btn-sm rounded">Inserir Produto</a>
                </div>
            </div>
    ...
    function mostrarRegistos(registos, pagina) {
        $.ajax({
            type: 'POST',
            url: 'php/int/int-produtos.php?mostrar=' + registos + '&pagina=' + pagina,
            data: {},
            cache: false,
            success: function(response) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'php/int/paginacao-produtos.php?mostrar=' + registos + '&pagina=' + pagina,
                    data: {},
                    cache: false,
                    success: function(response) {
    ...
    $(window).on('load', function() {
        if (inserir == 1) {
            Swal.fire(
                'Produto Inserido',
                'O produto foi introduzido com sucesso.',
                'success'
            ).then((result) => {
                if (result.isConfirmed) {
